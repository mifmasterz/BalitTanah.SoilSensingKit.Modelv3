...
namespace SSK.Core
{
    ...
    public class Engine
    {
        ...
        void DoAutoML(string DatasetFolder, string ModelFolder, uint TrainDuration = 60)
        {
        ...
        void SplitToMultipleCSV(string FileName, string TargetFolder)
        {
